...
const file_payment_proto_rawDesc = "" +
	"\n" +
	"\rpayment.proto\x12\bap2proto\x1a\x1fgoogle/protobuf/timestamp.proto\"C\n" +
	...
	"\n" +
	"max_amount\x18\x02 \x01(\x03R\tmaxAmount\"M\n" +
	"\x14ListPaymentsResponse\x125\n" +
	"\bpayments\x18\x01 \x03(\v2\x19.ap2proto.PaymentResponseR\bpayments2\xa6\x01\n" +
	"\x0ePaymentService\x12E\n" +
	"\x0eProcessPayment\x12\x18.ap2proto.PaymentRequest\x1a\x19.ap2proto.PaymentResponse\x12M\n" +
	"\fListPayments\x12\x1d.ap2proto.ListPaymentsRequest\x1a\x1e.ap2proto.ListPaymentsResponseB\x1fZ\x1dap2/contracts/gen/go/ap2protob\x06proto3"
...
var file_payment_proto_goTypes = []any{
	(*PaymentRequest)(nil),        // 0: ap2proto.PaymentRequest
	(*PaymentResponse)(nil),       // 1: ap2proto.PaymentResponse
	(*ListPaymentsRequest)(nil),   // 2: ap2proto.ListPaymentsRequest
	(*ListPaymentsResponse)(nil),  // 3: ap2proto.ListPaymentsResponse
	(*timestamppb.Timestamp)(nil), // 4: google.protobuf.Timestamp
}
var file_payment_proto_depIdxs = []int32{
	4, // 0: ap2proto.PaymentResponse.created_at:type_name -> google.protobuf.Timestamp
	1, // 1: ap2proto.ListPaymentsResponse.payments:type_name -> ap2proto.PaymentResponse
	0, // 2: ap2proto.PaymentService.ProcessPayment:input_type -> ap2proto.PaymentRequest
	2, // 3: ap2proto.PaymentService.ListPayments:input_type -> ap2proto.ListPaymentsRequest
	1, // 4: ap2proto.PaymentService.ProcessPayment:output_type -> ap2proto.PaymentResponse
	3, // 5: ap2proto.PaymentService.ListPayments:output_type -> ap2proto.ListPaymentsResponse
