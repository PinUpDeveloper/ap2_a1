...
const file_order_proto_rawDesc = "" +
	"\n" +
	"\vorder.proto\x12\fap2.order.v1\x1a\x1fgoogle/protobuf/timestamp.proto\")\n" +
	...
	"\fOrderService\x12X\n" +
	"\x17SubscribeToOrderUpdates\x12\x1a.ap2.order.v1.OrderRequest\x1a\x1f.ap2.order.v1.OrderStatusUpdate0\x01B(Z&ap2/contracts/gen/go/ap2proto;ap2protob\x06proto3"
...
var file_order_proto_goTypes = []any{
	(*OrderRequest)(nil),          // 0: ap2.order.v1.OrderRequest
	(*OrderStatusUpdate)(nil),     // 1: ap2.order.v1.OrderStatusUpdate
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_order_proto_depIdxs = []int32{
	2, // 0: ap2.order.v1.OrderStatusUpdate.updated_at:type_name -> google.protobuf.Timestamp
	0, // 1: ap2.order.v1.OrderService.SubscribeToOrderUpdates:input_type -> ap2.order.v1.OrderRequest
	1, // 2: ap2.order.v1.OrderService.SubscribeToOrderUpdates:output_type -> ap2.order.v1.OrderStatusUpdate
